...
?>
    ...
    <div class="home_four container left-space">
        ...
        <!-- nn{$term_name}<div class="col-switcher">
            ...
            while ( $the_query->have_posts() ) :  $the_query->the_post();
                ...
                <div class="column post_block col-sm-3 widget_anim">
                    ...
                    foreach($terms as $t){
                        ...
                        array_push($terms_html_array,"<span data-cat={$term_name}>{$term_name}</span>");
                    }
                    $terms_html_array = implode("<i class=comma>,</i> ",$terms_html_array);
                    ?>
                    <ul>
