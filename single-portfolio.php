...
<div class="container single-work left-space">
	...
	<div class="row related-work">
		<div class="col-sm-12">
			<h5 class="section-title"><?php _e("Other Work","um_lang"); ?></h5>
		</div>
        <?php
            if($related_posts):
	...
	var slideWidth;
		...
		function make_slider_height(){
			...
			console.log(slideWidth);
			jQuery(".slider-holder ul li").css("width",container_width);
			jQuery(".slider-holder ul li").css("height",container_width / ratio);
		}
